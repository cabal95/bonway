...
OBJS=main.o mdns_util.o mdns_query.o mdns_record.o mdns_a_record.o mdns_aaaa_record.o mdns_nsec_record.o mdns_ptr_record.o mdns_srv_record.o mdns_txt_record.o databuffer.o mdns_packet.o mdns_socket.o mdns_relay.o config_file.o config_service.o
